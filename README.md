...
Git clone the Android-FPVDemo project and run Android-FPVDemo.sh file for tutorial 


```
git clone https://github.com/DJI-Mobile-SDK/Android-FPVDemo.git Android-FPVDemo
cd Android-FPVDemo
bash Android-FPVDemo.sh
```
